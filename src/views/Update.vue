<template>
    <div>
        ...
        <div>
            ...
            <input type="text" v-model="dataNasc">
        </div>
        <div>
            <label for="">cpf:</label>
    ...
    methods: {
        atualizar() {
            let data = {
                idUser: this.id,
                nameUser: this.nome,
                birthdateUser: this.dataNasc,
                cpfUser: this.cpf,
                addressUser: this.endereco,
                mailUser: this.email,
                cepUser: this.cep,
                cityUser: this.cidade,
                stateUser: this.estado,
                passwordUser: this.senha
            }
            axios.put("/api/users/", JSON.stringify(data)).then((response) => {
